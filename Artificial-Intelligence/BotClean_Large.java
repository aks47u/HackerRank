...
public class BotClean_Large {
	...
	private static String getAction(String[] board, Node source,
		...
		if (destination == null) {
			throw new IllegalStateException(
					"Can't decide move with destination as null");
		}

		if (Math.abs(source.row - destination.row) < Math.abs(source.col
				- destination.col)) {
	...
	private static Graph<Node> newGraph(String[] board) {
	...
	private static void next_move(int posr, int posc, int dimh, int dimw,
			String[] board) {
